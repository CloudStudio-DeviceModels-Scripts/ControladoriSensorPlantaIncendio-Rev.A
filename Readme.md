...
# Parsing + Configuration Script – Controlador iSensor Planta Incendio - Rev. A

This **Parsing + Configuration** script is designed for the **Controlador iSensor Planta Incendio** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Controlador iSensor Planta Incendio Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Controlador iSensor Planta Incendio** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
