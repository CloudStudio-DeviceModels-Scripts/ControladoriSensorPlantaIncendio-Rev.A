...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  // temperatura, mientras que el segundo es un sensor de dióxido de carbono.
    ...
    endpoints.addEndpoint("1", "Sensor nivel incendio 1", endpointType.volumeSensor );
    endpoints.addEndpoint("2", "Sensor nivel incendio 2", endpointType.volumeSensor );
    endpoints.addEndpoint("3", "Sensor nivel incendio 3", endpointType.volumeSensor );
    endpoints.addEndpoint("4", "Sensor nivel incendio 4", endpointType.volumeSensor );
    endpoints.addEndpoint("5", "Sensor nivel petroleo 5", endpointType.volumeSensor );
